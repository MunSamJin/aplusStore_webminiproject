...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $("#cart").click(function () {
                    let modelName = model.options[model.selectedIndex].value+"_"+
                        color.options[color.selectedIndex].value+"_"+
                        size.options[size.selectedIndex].value+"_"
                    +gps.options[gps.selectedIndex].value;
            ...
            <table>
                        ...
                        <div class="container">
                            <div class="col-md-12 col-sm-12 nopadding">
                                <div class="pricing-intro">
                                    <h1 class="wow fadeInUp" data-wow-delay="0.2s">Apple Watch 8 구입하기</h1>
                                </div>
                            </div>
                        </div>
                ...
                <tr>
                    <td rowspan="2" style="width: 50%">
                        <img src="../images/watch_8_main.jpeg" width="100%" height="100%">
                    </td>
                ...
                <tr>
                    <td>
                        <h2>모델 선택하기</h2>
                        <select id="model">
                            <option value="aluminum8">알루미늄</option>
                            <option value="stainless8">스테인리스</option>
