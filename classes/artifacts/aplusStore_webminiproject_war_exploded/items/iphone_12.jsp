...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $("#cart").click(function () {
                    let modelName = color.options[color.selectedIndex].value+"_"+
                        storage.options[storage.selectedIndex].value;

                    location.href = "cart.jsp?modelName=12_"+modelName;
                });
            ...
            <table>
                ...
                <tr>
                    <td rowspan="2" style="width: 70%">
                        <img src="../images/iphone12_main.jpeg" width="100%" height="100%">
                    </td>
