        ...
        <div class="container">
            <div class="col-md-12 col-sm-12 nopadding">
                <div class="pricing-intro">
                    <h1 class="wow fadeInUp" data-wow-delay="0.2s">Apple Watch 8 구매하기</h1>
                    ₩ 590,000부터
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 nopadding">
            <div class="split-content" id="jong">
                ...
                <p class="wow fadeInUp">
                    ...
                    <input type="radio" name="model" id="aluminum" value="aluminum">

                    <label for="stainless">stainless</label>
                    <input type="radio" name="model" id="stainless" value="stainless">
                ...
                <p class="wow fadeInUp">
                    ...
                    <label for="41">41mm</label>
                    <input type="radio" name="size" id="41" value="41">
                    <label for="45">45mm</label>
                    <input type="radio" name="size" id="45" value="45">
