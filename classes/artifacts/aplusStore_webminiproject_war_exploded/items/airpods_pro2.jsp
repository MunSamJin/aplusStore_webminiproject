        ...
        <div class="container">
            <div class="col-md-12 col-sm-12 nopadding">
                <div class="pricing-intro">
                    <h1 class="wow fadeInUp" data-wow-delay="0.2s">AirPods Pro 2세대 구입하기</h1>
                </div>
            </div>
        </div>
...
<div class="split-features">
    <div class="col-md-6 nopadding">
        <div class="split-image">
            <img class="img-responsive wow fadeIn" src="../images/airpodpro_main.jpeg" alt="airpod 2세대 사진"
                 style="height: 450px; border-radius: 20px"/> </div>
    </div>
    <div class="col-md-6 nopadding">
        <div class="split-content">
            <h1 class="wow fadeInUp">에어팟 프로 2세대</h1>
            <span id="span" ><h1> ₩ 359,000</h1></span>
