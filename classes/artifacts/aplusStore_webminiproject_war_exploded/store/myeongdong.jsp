				...
				let map = new kakao.maps.Map(container, options);
		     	...
		     	//마커가 표실될 위치
		      	...
		      	//marker.setMap(null); 
	   		    ...
	   		    let content = "<div class ='label'><span class='left'></span><button class='center'>"+"A+ Store 명동"+"<br>전자제품 판매점</button><span class='right'></span></div>";
	      ...
	      <div class="container nopadding">
	        ...
	        <div style="margin-left: auto; margin-right: auto; text-align: center;">
	          <div class="hero-content">
	            <h1 class="wow fadeInUp" data-wow-delay="0.1s">A+ Store 명동</h1>
	          ...
	          <div>
	            <div class="wow fadeInUp" data-wow-delay="0.4s">
	              <table >
	              	...
	              	<tr><td>찾아오는 길</td></tr>
	              	<tr><td><br></td></tr>
	              	<tr><td>A+ Store 명동은 명동 쇼핑 중심지 내 남대문로에 위치해있으며, 롯데백화점을 바로 맞은 편에 두고 있습니다. 주차 공간이 여의치 않으므로 대중교통을 이용하시길 바랍니다. 대중교통편: 지하철 2호선 을지로역 6번 출구에서 하차하시면 됩니다.</td></tr>
	              </table>
	            </div>
	          </div>
