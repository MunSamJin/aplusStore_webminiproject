    ...
    <div class="container nopadding">
      ...
      <div class="col-md-7">
        <div class="hero-content">
          ...
          <p class="wow fadeInUp" data-wow-delay="0.1s"> A+ Store 에 오신것을 환영합니다! </p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="reviews owl-carousel owl-theme">
        <div class="review-single">
          <img class="img-circle" src="${path}/images/imgStore/KakaoTalk_1.jpg" width= "70px" alt="Client Testimonoal"/>
          <div class="review-text wow fadeInUp" data-wow-delay="0.2s">
            <p></p>
            <h3>고종영</h3>
            <h3>상품 + QnA backEnd</h3>
          </div>
        </div>
        <div class="review-single"><img class="img-circle" src="${path}/images/imgStore/KakaoTalk_2.png" alt="Client Testimonoal" />
        ...
        <div class="review-single"><img class="img-circle" src="${path}/images/imgStore/KakaoTalk_3.jpg" alt="Client Testimonoal" />
          <div class="review-text">
            <p></p>
            <h3>엄용식</h3>
            <h3>회원</h3>
        ...
        <div class="review-single"><img class="img-circle" src="${path}/images/imgStore/KakaoTalk_4.png" alt="Client Testimonoal" />
          <div class="review-text">
            <p></p>
            <h3>채란</h3>
            <h3>주문</h3>
        ...
        <div class="review-single"><img class="img-circle" src="${path}/images/imgStore/KakaoTalk_5.jpg" alt="Client Testimonoal" />
          <div class="review-text">
            <p></p>
            <h3>문삼진</h3>
            <h3>배송</h3>
        ...
        <div class="review-single"><img class="img-circle" src="${path}/images/imgStore/KakaoTalk_6.png" alt="Client Testimonoal" />
          <div class="review-text">
            <p></p>
            <h3>안효경</h3>
            <h3>front -QnA, MainPage</h3>
          </div>
        </div>
      </div>
    </div>
