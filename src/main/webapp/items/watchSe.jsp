    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#cart").click(function () {
                ...
                location.href = "cart.jsp?modelName=se_"+modelName;
            });
            ...
            <table>
                        ...
                        <div class="container">
                            <div class="col-md-12 col-sm-12 nopadding">
                                <div class="pricing-intro">
                                    <h1 class="wow fadeInUp" data-wow-delay="0.2s">Apple Watch SE 구입하기</h1>
                                </div>
                            </div>
                        </div>
                ...
                <tr>
                    <td rowspan="2" style="width: 50%">
                        <img src="../images/watch_se_main.jpeg" width="100%" height="100%">
                    </td>
