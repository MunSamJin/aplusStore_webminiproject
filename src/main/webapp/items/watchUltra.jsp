    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $("#cart").click(function () {
                    ...
                    location.href = "cart.jsp?modelName=ultra_"+modelName+"_49_cellular";
                });
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="../index.html"><img src="../images/logo1.png" width="80"
                                                                                 alt="apluslogo"/></a></div>
            ...
            <table>
                        ...
                        <div class="container">
                            <div class="col-md-12 col-sm-12 nopadding">
                                <div class="pricing-intro">
                                    <h1 class="wow fadeInUp" data-wow-delay="0.2s">Apple Watch Ultra 구입하기</h1>
                                </div>
                            </div>
                        </div>
                ...
                <tr>
                    <td rowspan="2" style="width: 50%">
                        <img src="../images/watch_ultra_main.jpeg" width="100%" height="100%">
                    </td>
